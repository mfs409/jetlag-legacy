...
- [inv_alien.png](endless_runner_game/inv_alien.png)
- [sep_alien.png](endless_runner_game/sep_alien.png)
...
- [inv_alien.json](endless_runner_game/inv_alien.json)
- [sep_alien.json](endless_runner_game/sep_alien.json)
