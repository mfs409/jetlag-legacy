...
export enum KeyCodes {
  ...
  KEY_DELETE = 'Delete', KEY_BACKQUOTE = 'Backquote', KEY_DIGIT1 = 'Digit1', KEY_DIGIT2 = 'Digit2',
  KEY_DIGIT3 = 'Digit3', KEY_DIGIT4 = 'Digit4', KEY_DIGIT5 = 'Digit5', KEY_DIGIT6 = 'Digit6',
  KEY_DIGIT7 = 'Digit7', KEY_DIGIT8 = 'Digit8', KEY_DIGIT9 = 'Digit9', KEY_DIGIT0 = 'Digit0',
  KEY_MINUS = 'Minus', KEY_EQUAL = 'Equal', KEY_BACKSPACE = 'Backspace', KEY_Q = 'KeyQ',
  KEY_W = 'KeyW', KEY_E = 'KeyE', KEY_R = 'KeyR', KEY_T = 'KeyT',
  KEY_Y = 'KeyY', KEY_U = 'KeyU', KEY_I = 'KeyI', KEY_O = 'KeyO',
  KEY_P = 'KeyP', KEY_BRACKETLEFT = 'BracketLeft', KEY_BRACKETRIGHT = 'BracketRight', KEY_BACKSLASH = 'Backslash',
  KEY_A = 'KeyA', KEY_S = 'KeyS', KEY_D = 'KeyD', KEY_F = 'KeyF',
  KEY_G = 'KeyG', KEY_H = 'KeyH', KEY_J = 'KeyJ', KEY_K = 'KeyK',
  KEY_L = 'KeyL', KEY_SEMICOLON = 'Semicolon', KEY_QUOTE = 'Quote', KEY_ENTER = 'Enter',
  KEY_Z = 'KeyZ', KEY_X = 'KeyX', KEY_C = 'KeyC', KEY_V = 'KeyV',
  KEY_B = 'KeyB', KEY_N = 'KeyN', KEY_M = 'KeyM', KEY_COMMA = 'Comma',
  KEY_PERIOD = 'Period', KEY_SLASH = 'Slash', KEY_SPACE = 'Space', KEY_PAGEUP = 'PageUp',
  KEY_PAGEDOWN = 'PageDown', KEY_LEFT = 'ArrowLeft', KEY_UP = 'ArrowUp', KEY_DOWN = 'ArrowDown',
